    ...
    <div className="flex justify-center mb-6">
      ...
      {!image ? (
        ...
        <div className="relative">
            ...
            />
            <button type="button" className="w-8 h-8 flex items-center justify-around bg-red-500 text-white rounded-full absolute -bottom-1 -right-1 cursor-pointer" onClick={handleRemoveImage}>
                <LuTrash />
            </button>
        </div>
      )}
